...
//Your task is to create a JavaScript 
...
class Car {
  ...
  const carA = new Car("Cruiser", "Prado", 2022, true);
  const carB = new Car("Volkswagen", "Jetta", 2018, false);
  
  carA.toggleAvailability(); 
...
class Rental {
  ...
  const carC = new Car("Cruiser", "Prado", 2022, true);
  const carD = new Car("Volkswagen", "Jetta", 2018, false);

  
  const rentalA = new Rental(carC, "Kami Luther", new Date("2024-04-01"), new Date("2024-04-05"));
const rentalB = new Rental(carD, "Kelly Mulia", new Date("2024-04-10"), new Date("2024-04-15"));

console.log(rentalA.calculateRentalDuration()); 
console.log(rentalA.calculateRentalDuration());
...
const car = new Car("Cruiser", "Prado", 2022, true);
const rental = new Rental(car, "Kelly Mulia", new Date("2024-04-20"), new Date("2024-04-25"));
...
// The Question class should also have a method called checkAnswer that takes a user's answer as a parameter and returns true if the answer
...
class Question {
  ...
  const qstn_A = new Question(
    "What is the name of Rwandan currency?",
    ["Dollars", "Shillings", "Francs", "Peso"],
    "Francs"
  );
  
 
  const userAnswer = "Peso";
  console.log(qstn_A.checkAnswer(userAnswer)); 
...
// ● submitAnswer: Takes a user's answer as a parameter, checks if the answer is correct using the checkAnswer 
//method of the Question class, and updates the score if the answer is correct.
...
const quiz = new Quiz();
const qstn1 = new Question("What is 100**0?", [0,100,1,1000], 1);
const qstn2 = new Question("What is the biggest country in Africa?", ["Nigeria", "DRCongo", "Kenya", "Cameroon", "Algeria"], "Algeria");
quiz.addQuestion(qstn1);
quiz.addQuestion(qstn2);
quiz.submitAnswer(1);
quiz.submitAnswer("Aligeria");
